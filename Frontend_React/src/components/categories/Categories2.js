          ...
          <div class="row g-4">
            <div class="col-sm-12 col-md-8 d-flex align-items-center">
              ...
              <div class="text-start ps-4">
                <p><h5 class="mb-3">Sales Assosiative</h5>
                        <p class = "mb-4">Skill Lync</p>
                </p>
          ...
          <div class="row g-4">
            <div class="col-sm-12 col-md-8 d-flex align-items-center">
              <img class="flex-shrink-0 img-fluid border rounded c1" src="img/com-logo-1.jpg"
                alt="" />
              <div class="text-start ps-4">
                <p><h5 class="mb-3">Sales Executive</h5>
                        <p class = "mb-4">Refier</p>
                </p>
          ...
          <div class="row g-4">
            <div class="col-sm-12 col-md-8 d-flex align-items-center">
              <img class="flex-shrink-0 img-fluid border rounded c1" src="img/com-logo-1.jpg"
                alt="" />
              <div class="text-start ps-4">
                <p><h5 class="mb-3">Enterprise Sales Manager</h5>
                        <p class = "mb-4">Refier</p>
                </p>
          ...
          <div class="row g-4">
            <div class="col-sm-12 col-md-8 d-flex align-items-center">
              <img class="flex-shrink-0 img-fluid border rounded c1" src="img/com-logo-1.jpg"
                alt="" />
              <div class="text-start ps-4">
                <p><h5 class="mb-3">Reporting Specialist - SEO</h5>
                        <p class = "mb-4">Boldiful</p>
                </p>
